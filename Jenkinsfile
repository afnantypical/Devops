pipeline {
    ...
    stages {
        stage('Checkout Code') {
            steps {
                git branch: 'main', url: 'https://github.com/afnantypical/Devops.git'
            }
        }
    ...
    post {
        success {
            ...
            echo "Email notification: Build succeeded! To: syedafnan10659@gmail.com"
        }
        failure {
            echo "❌ Build failed for ${APP_NAME}"
            echo "Email notification: Build ${BUILD_NUMBER} failed! To: syedafnan10659@gmail.com"
        }
    }
}
